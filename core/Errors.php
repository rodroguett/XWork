...
class Errors {
          ...
          public static function launch($exc){
                    ...
                    $c = $b[(count($b)-1)];
                    switch ($c) {
                              case 'ServerException': self::serverException_handler($exc); break; 
                              case 'DatabaseException': self::databaseException_handler($exc); break; 
                              case 'PDOException': self::PDOException_handler($exc); break; 
                              default: self::unknown_handler($exc); break;
                    }
          }
          ...
          public static function serverException_handler($exc) {
                    ...
                    switch ($exc->getCode()) {
                              case 404:header("HTTP/1.0 404 No Encontrado"); break;
                              case 500:header("HTTP/1.0 500 Error interno del Servidor"); break;
